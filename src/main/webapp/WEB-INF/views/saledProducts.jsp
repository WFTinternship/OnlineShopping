...
<div class="clear"></div>
<form action="/getDiscountPage" method="post" id="form_id"  name="productForm" >
    <div id="icons">

        <button  value="0" class = "littleButtons" onclick="function1();"><img src="/resources/image/edit.jpg" alt="edit" style="height: 40px; width:42px;"></button>
